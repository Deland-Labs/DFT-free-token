...
Feature: FreeToken
  ...
  Background:
    Given Reinstall dft canisters
      ...
      | token_WICP     | W ICP    | WICP     | 0        | 10^9         | main  |
      | token_WUSD     | W USD    | WUSD     | 0        | 10^9         | main  |
      | token_mintable | mintable | mintable | 0        | 10^9         | main  |
    And Reinstall freeToken and registrar canisters
    And give blind_box some quotas from "main"
      | quota_type | len | diff |
      | LenGte     | 7   | 1000 |
      | LenGte     | 6   | 1000 |
      | LenGte     | 5   | 1000 |
      ...
      | LenGte     | 2   | 1000 |
      | LenGte     | 1   | 1000 |
    And transfer token from "main" to canister
  ...
  Scenario: FreeToken
    ...
    When add reward token "free_token"
  ...
  Scenario: FreeToken insufficient quota, should failed Reward incomplete
    ...
    When add reward token "free_token"
      | code     | quota_canister | len | diff | dicp_canister | dicp_amount | mint_canister  | mint_amount | user |
      | reward_1 | registrar      | 4   | 5    | token_WICP    | 1000        | token_mintable | 1200        | main |
    Then Users receive tokens for free code "reward_1"
      | user  |
      | main  |
      | user1 |
